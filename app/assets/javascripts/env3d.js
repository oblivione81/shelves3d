...
function addBookCaseToScene()
{
    if (env3d_model_bookcases.length < env3d_bookcase_slots.length)
    {
        ...
        var light = new THREE.SpotLight(0xFFD6AA, 0.1);
